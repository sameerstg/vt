"use client";
import { dasboardNavigation } from "@/data/dashboardAdmin"; // We'll create this data file
                        ...
                        <div className="dboard_notific_dd px30 pt10 pb15">
                          <div className="notif_list d-flex align-items-center bdrb1 pb15 mb10">
                            ...
                            <div className="details ml10">
                              <p className="text mb-0">New dispute raised</p>
                              <p className="text mb-0">requires review</p>
                            </div>
                          </div>
                          <div className="notif_list d-flex align-items-center bdrb1 pb15 mb10">
                            <Image
                            ...
                            />
                            <div className="details ml10">
                              <p className="text mb-0">User verification pending</p>
                              <p className="text mb-0">approval needed</p>
                            </div>
                          </div>
                        </div>
                      </div>
