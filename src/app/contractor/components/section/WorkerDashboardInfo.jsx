  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const [projectsRes] = await Promise.all([
        fetch("/api/contractor?type=assigned"),
      ]);
      const projectsData = await projectsRes.json();

      if (projectsData.success) {
        const assigned = projectsData.data.assignedProjects || [];
        const pending = [];
                ...
                <div className="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                  ...
                  {recentProjects.length === 0 ? (
                    <div className="text-center p20">
                      ...
                      <Link href="/contractor/browse-projects" className="ud-btn btn-thm btn-sm">
                        Browse Projects
                      </Link>
                    </div>
                  ) : (
                    <div className="dashboard-widget-list">
                      {recentProjects.map((project) => (
                        <div key={project.id} className="widget-item pb15">
                          <Link href={`/contractor/project/${project.id}`} className="d-block">
              ...
              {/* <div className="col-md-6 col-xxl-4">
                <div className="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                  ...
                  <div className="quick-actions">
                    <Link href="/contractor/browse-projects" className="action-item mb10 d-block">
