...
const assignments = new Map([
  ...
  // IN_REVIEW (5)
  ["asgn-r1", { id: "asgn-r1", contractorId: "contractor-001", workerId: "worker-021", workerName: "Alex Thompson", teamName: "Web Dev Team Alpha", projectId: "proj-C11", projectTitle: "SaaS Platform Build", milestoneId: "ms-C11-1", milestoneTitle: "Design Phase", pay: 400, deadline: dl(-1), status: "IN_REVIEW", note: null, createdAt: d(15) }],
  ["asgn-r1b", { id: "asgn-r1b", contractorId: "contractor-001", workerId: "worker-021", workerName: "Alex Thompson", teamName: "Web Dev Team Alpha", projectId: "proj-C09", projectTitle: "Enterprise ERP System", milestoneId: null, milestoneTitle: "Search Feature", pay: 650, deadline: dl(-2), status: "IN_REVIEW", note: "Full-text search with filters", createdAt: d(13) }],
  ["asgn-r1c", { id: "asgn-r1c", contractorId: "contractor-001", workerId: "worker-021", workerName: "Alex Thompson", teamName: "QA & Testing Team", projectId: "proj-C10", projectTitle: "Hospital Management System", milestoneId: null, milestoneTitle: null, pay: 500, deadline: dl(0), status: "IN_REVIEW", note: null, createdAt: d(12) }],
  ["asgn-r1d", { id: "asgn-r1d", contractorId: "contractor-001", workerId: "worker-021", workerName: "Alex Thompson", teamName: "Mobile Dev Squad", projectId: "proj-C12", projectTitle: "Warehouse Automation", milestoneId: null, milestoneTitle: "Export Module", pay: 750, deadline: dl(-3), status: "IN_REVIEW", note: "CSV and Excel export functionality", createdAt: d(14) }],
  ["asgn-r1e", { id: "asgn-r1e", contractorId: "contractor-001", workerId: "worker-021", workerName: "Alex Thompson", teamName: "Product Team", projectId: "proj-C11", projectTitle: "SaaS Platform Build", milestoneId: null, milestoneTitle: "User Onboarding", pay: 900, deadline: dl(-1), status: "IN_REVIEW", note: null, createdAt: d(11) }],
