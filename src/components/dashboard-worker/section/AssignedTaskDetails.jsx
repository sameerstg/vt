...
export default function AssignedTaskDetails() {
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="ps-widget bgc-white bdrs4 p30 mb30 text-center">
              ...
              <Link href="/worker-dashboard/tasks?tab=assigned" className="ud-btn btn-thm">
      ...
      <div className="dashboard__content hover-bgc-color">
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="ps-widget bgc-white bdrs4 p30 mb30 text-center">
              <h4>Invalid Task</h4>
              <p className="text mb20">This task is not in your assigned tasks.</p>
              <Link href="/worker-dashboard/tasks?tab=assigned" className="ud-btn btn-thm">
                Back to Assigned Tasks
              </Link>
            </div>
  ...
  const handleStartTask = () => {
    router.push(`/worker-dashboard/manage-projects?taskId=${task.id}&taskTitle=${encodeURIComponent(task.title)}`);
  };
      ...
      <div className="row pb40">
        ...
        <div className="col-lg-12">
          <div className="dashboard_title_area">
            <h2>Assigned Task Details</h2>
            <p className="text">Review your assigned task details.</p>
          </div>
        </div>
      </div>
        ...
        <div className="col-xl-12">
          <div className="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
            ...
            <div className="d-flex justify-content-between align-items-center mb30">
              ...
              <Link href="/worker-dashboard/tasks?tab=assigned" className="ud-btn btn-light-default">
                ← Back to List
              </Link>
            </div>
            ...
            <div className="row g-4 mb30">
              ...
              <div className="col-md-6">
                <div className="bdr1 bdrs8 p20">
                  <h5 className="mb15">Assignment Info</h5>
                  <p className="mb8"><strong>Assigned on:</strong> {new Date().toLocaleDateString()}</p>
                  <p className="mb8"><strong>Action required:</strong> Please start the work before the deadline.</p>
                </div>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-end gap-3 mt30">
              ...
              <button onClick={handleStartTask} className="ud-btn btn-thm">
                Start Working
              </button> */}
            </div>
          </div>
