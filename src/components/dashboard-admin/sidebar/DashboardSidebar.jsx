        ...
        <div className="dashboard_sidebar_list -mt-40">
          {navigationItems.map((item, index) => {
            ...
            return (
              <div
                key={item.id || index}
                className={`sidebar_list_item ${index === 0 ? "mt-4" : "mb-1"} ${
                  hasChildren ? "sidebar-dropdown-item" : ""
                }`}
              >
                {hasChildren ? (
                  <>
                    <button
                      type="button"
                      className={`items-center sidebar-parent-trigger ${
                    ...
                    >
                      ...
                      <i
                        className={`fas fa-chevron-down sidebar-toggle-arrow ${
                          openMenus[item.name] ? "open" : ""
                        }`}
                        aria-hidden="true"
                      />
                    </button>
