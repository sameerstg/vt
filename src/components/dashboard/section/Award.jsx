            ...
            {editingIds.includes(item.id) ? (
              <div className="record-editor">
                <div className="record-editor__head">
                  <span className="record-editor__badge">A</span>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="mb20">
                      <label className="heading-color ff-heading fw500 mb10">Award Title</label>
                      <input
                        type="text"
                  ...
                  <div className="col-md-6">
                    <div className="mb20">
                      <label className="heading-color ff-heading fw500 mb10">Issuer</label>
                      <input
                        type="text"
                        className="form-control"
                        value={item.issuer}
                        onChange={(event) => handleFieldChange(item.id, "issuer", event.target.value)}
                      />
                    </div>
                  </div>
                  <div className="col-md-6">
              ...
              <div className="record-card">
                ...
                <h5 className="mt15">{item.title || "Award title"}</h5>
                <h6 className="text-thm">{item.issuer || "Issuer"}</h6>
                <p className="mb-0">
                  {item.description || "Add award details and context."}
                </p>
              </div>
            )}
          </div>
