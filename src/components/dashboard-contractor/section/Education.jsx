            ...
            {editingIds.includes(item.id) ? (
              <div className="record-editor">
                <div className="record-editor__head">
                  <span className="record-editor__badge">E</span>
                  ...
                  <div className="col-md-6">
                    <div className="mb20">
                      ...
                      <input
                        ...
                        value={item.degree}
                        onChange={(event) => handleFieldChange(item.id, "degree", event.target.value)}
                      />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="mb20">
                      <label className="heading-color ff-heading fw500 mb10">Institute</label>
                      <input
                        type="text"
                        className="form-control"
                        value={item.institute}
                        onChange={(event) => handleFieldChange(item.id, "institute", event.target.value)}
                      />
                    </div>
                  </div>
                  <div className="col-md-6">
              ...
              <div className="record-card">
                ...
                <h5 className="mt15">{item.degree || "Degree title"}</h5>
                <h6 className="text-thm">{item.institute || "Institute"}</h6>
                <p className="mb-0">
                  {item.description || "Add coursework, focus area, or education summary."}
                </p>
              </div>
            )}
          </div>
